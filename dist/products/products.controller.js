...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 409, description: 'Product name already exists' }),
...
__decorate([
    (0, common_1.Get)('by-api-key/:apiKey'),
    (0, swagger_1.ApiOperation)({ summary: 'Find product by API key (used by gateway)' }),
    (0, swagger_1.ApiParam)({ name: 'apiKey', description: 'Product API key' }),
    ...
    __metadata("design:returntype", void 0)
], ProductsController.prototype, "findByApiKey", null);
__decorate([
    (0, common_1.Get)(':id'),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Update product status (activate/deactivate)' }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'Product UUID' }),
