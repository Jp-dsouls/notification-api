...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Channel created successfully' }),
    (0, swagger_1.ApiResponse)({ status: 409, description: 'Channel name already exists' }),
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'List all channels' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'List of channels' }),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiParam)({ name: 'id', description: 'Channel UUID' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Channel found' }),
